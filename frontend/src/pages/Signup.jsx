...
const Signup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL || "http://localhost:5000"}/api/v1/user/register`, formData, {
        headers: {
              ...
              <div className="relative">
                ...
                {showPassword ? (
                  <EyeOff
                    ...
                    className="h-5 w-5 absolute right-2 text-gray-700 bottom-2"
                  />
                ) : (
                  <Eye
